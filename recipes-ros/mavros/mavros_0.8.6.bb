...
DEPENDS = "angles boost catkin cmake-modules diagnostic-msgs diagnostic-updater libeigen eigen-conversions geometry-msgs packagegroup-ros-comm mavlink message-generation message-runtime pluginlib python-argparse rosconsole-bridge roscpp rospy sensor-msgs std-msgs std-srvs tf2-ros libmavconn"
